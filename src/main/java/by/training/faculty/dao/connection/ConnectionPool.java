...
public final class ConnectionPool {
    ...
    private BlockingQueue<Connection> connectionQueue; //свободные соединения
    private BlockingQueue<Connection> givenAwayConnectionQueue; //занятые соединения
    ...
    public void initPoolData() throws ConnectionPoolException {
        try{
            ...
            throw new ConnectionPoolException("Can't found class in ConnectionPool", e);
        }
    }
